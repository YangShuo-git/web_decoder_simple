...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/baiyang/WasmPlayer/3rdlibs/ffmpeg-4.4.1/../../web_server/ffmpeg --disable-everything --disable-x86asm --enable-muxer=h264 --enable-demuxer=h264 --enable-protocols
...
CC_IDENT=gcc 9 (Ubuntu 9.4.0-1ubuntu1~20.04.1)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
OBJCFLAGS=  
ASFLAGS=   -fPIC -g
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -m64 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include ./compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
